...
description: Install Supernal Coding and create your first compliant project in 5 minutes
---

# Getting Started with Supernal Coding

**Get up and running with Supernal Coding in 5 minutes.**

This section covers:
- **Installation** - Get the CLI installed globally
- **Quick Start** - Create your first compliant project
- **Core Concepts** - Understand requirements, phases, and workflows
- **First Development Cycle** - Complete a feature from start to finish
...
1. ✅ Supernal Coding CLI installed
2. ✅ A project with requirements tracking
3. ✅ Git hooks for automated validation
4. ✅ Your first requirement created and tracked
...
sc req update REQ-001 --status=in-progress         # Mark as in-progress
...
3. **Development**: `sc git-smart branch` + `sc req update --status=in-progress`
